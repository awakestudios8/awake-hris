...
let mh=0,mt=0,ma=0,mol=0,mow=0,miz=0,msk=0;em.forEach(e=>{const rc2=pR(e.id,e.pd);mh+=rc2.h;mt+=rc2.t;ma+=rc2.a;mol=rj(mol+rc2.ol);mow=rj(mow+rc2.ow);miz+=rc2.iz;msk+=rc2.sk;});
...
<div className="sg">{[{l:"Kehadiran",v:mh,c:"#16a34a",Ic:UserCheck},{l:"Sakit",v:msk,c:"#dc2626",Ic:X},{l:"Izin",v:miz,c:"#7c3aed",Ic:FileText},{l:"Alpha",v:ma,c:"#ef4444",Ic:AlertTriangle},{l:"Lembur",v:fj(rj(mol+mow)),c:"#d97706",Ic:TrendingUp},{l:"Pending",v:pN,c:BR,Ic:Clock}].map((x,i)=><div key={i} className="sc"><div style={{display:"flex",alignItems:"center",gap:10}}><div style={{width:36,height:36,borderRadius:10,background:x.c+"12",display:"flex",alignItems:"center",justifyContent:"center"}}><x.Ic size={16} color={x.c}/></div><div><div className="sl">{x.l}</div><div className="sv2" style={{color:x.c}}>{x.v}</div></div></div></div>)}</div></div>
