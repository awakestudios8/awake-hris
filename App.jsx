...
const ensureH2C=async()=>{if(!window.html2canvas)await loadScript("https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js");return window.html2canvas;};
...
const rc3=(()=>{if(!emp||pI3<0)return{h:0,sk:0,iz:0,t:0,a:0,ol:0,ow:0};
const pd4=emp.pd||1;let sd3,ed3;
if(pd4===1){sd3=new Date(pY3,pI3,1);ed3=new Date(pY3,pI3+1,0);}
else{sd3=new Date(pY3,pI3,pd4);ed3=new Date(pY3,pI3+1,pd4-1);}
...
ded3.forEach(function(x){h2c+="<div style='display:flex;justify-content:space-between;padding:7px 0;font-size:12px;border-bottom:1px solid #f5f3ec'><span>"+x.l+"</span><span style='font-weight:700;color:#AF1917'>-"+fm(x.a)+"</span></div>";});}
h2c+="<div style='background:linear-gradient(135deg,#AF1917,#6b0f0e);color:#fff;padding:14px 16px;border-radius:12px;margin-top:16px;display:flex;justify-content:space-between;font-weight:800;font-size:15px'><span>TOTAL DITERIMA</span><span style='font-size:17px'>"+fm(tot.n)+"</span></div>";
if(dt.nt)h2c+="<div style='margin-top:14px;padding:10px 14px;background:#f5f3ec;border-radius:10px;font-size:11px;color:#64748b;font-style:italic'>"+dt.nt+"</div>";
...
const h2cFn=await ensureH2C();const canvas=await h2cFn(el,{scale:2,useCORS:true,backgroundColor:"#ffffff"});
...
const h2cFn2=await ensureH2C();const canvas2=await h2cFn2(el2,{scale:2,useCORS:true,backgroundColor:"#ffffff",logging:false});
